    ...
    return (
        <>
            <div className=' opacity w-full py-[8rem]'>
                ...
                <div className='w-5/6 space-y-5  mx-auto flex flex-col lg:flex-row'>
                            ...
                            <div className='flex lg:flex-row justify-center  items-center flex-col'>
                                ...
                                <div className='flex flex-col ml-4 space-y-1'>
                                    <div>
                                        ...
                                        <p className='text-2xl text-Header bold font-jost font-[900]'>Take your Exam</p>
                                    </div>
                                    <div>
                    ...
                    <div className='md:w-1/2 w-full mt-8 '>
                        <div className='flex justify-center items-center '>
                            <div className='relative '>
                                ...
                                <div className='absolute h-[5rem] w-[5rem] text-white z-20 rounded-full bg-Theme flex justify-center items-center bottom-[1rem] lg:bottom-[2.25rem] left-[3rem] '>
